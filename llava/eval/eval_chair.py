...
class CHAIR(object):
    ...
    def __init__(self, imids, coco_path):
        ...
        # read in synonyms
        synonyms = open('./playground/data/eval/chair/synonyms.txt').readlines()
    ...
    def caption_to_words(self, caption):
        ...
        words = [lemma.lemmatize(w, 'n') for w in words]
...
def save_hallucinated_words(cap_file, cap_dict):
    ...
    os.makedirs('./playground/data/eval/chair/hallucination/', exist_ok=True)
    with open('./playground/data/eval/chair/hallucination/hallucinated_words_%s' % tag, 'w') as f:
...
if __name__ == '__main__':
    ...
    parser.add_argument("--annotation_path", type=str,
                        default='./playground/data/eval/chair/annotations/')
    parser.add_argument("--log-file", type=str, default='./playground/data/eval/chair/scores0.csv')
    ...
    header = ['cap_file', 'CHAIRs', 'CHAIRs']
    write_to_csv(args.log_file,
                 header,
                 [args.cap_file,
                  cap_dict['overall_metrics']['CHAIRs']*100,
                  cap_dict['overall_metrics']['CHAIRi']*100])
